      ...
      <div className="flex flex-col md:flex-row md:items-center justify-between gap-4 mb-6">
        ...
        <div className="flex flex-wrap items-center gap-2">
          ...
          >
            ...
            {isExtracting ? 'Consultando BD de Agencia...' : 'Extraer Base de Datos'}
          </button>
                ...
                if (averageScore >= 88) {
                  ...
                  >
                    ...
                    >
                      <div className="flex items-center gap-3">
                        {app.avatarUrl ? (
                          ...
                          <motion.div 
                            whileHover={{ scale: 1.05 }}
                            className={`w-9 h-9 rounded-xl bg-gradient-to-br from-indigo-500 to-cyan-500 flex items-center justify-center font-bold text-white tracking-wide border ${
                              isDarkMode ? 'border-white/20' : 'border-slate-200 shadow-sm'
                            }`}
                          >
                            {app.name.charAt(0)}
                          </motion.div>
                    ...
                    <td className="py-3.5 px-4 text-center">
                      <span className={`inline-block text-[10px] font-semibold tracking-wider font-mono px-2.5 py-1 rounded-full border ${getStatusStyle(app.status)}`}>
