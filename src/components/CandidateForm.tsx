...
export default function CandidateForm({
  ...
  const handleSubmit = (e: React.FormEvent) => {
    e.preventDefault();
    if (!name || !email || !role) {
      alert("El nombre, correo electrónico y puesto de interés son campos obligatorios.");
      return;
    }
  ...
  return (
    <div className={`fixed inset-0 z-50 overflow-y-auto backdrop-blur-md flex items-center justify-center p-4 transition-colors duration-300 ${
