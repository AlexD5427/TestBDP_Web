                          ...
                          >
                            <div className="flex items-center gap-3">
                              {cand.avatarUrl ? (
                                ...
                                <div className="w-10 h-10 rounded-xl bg-cyan-500/10 border border-cyan-500/20 flex items-center justify-center text-cyan-300 text-xs font-bold font-mono">
                                  {cand.name.charAt(0)}
                                </div>
                              )}
